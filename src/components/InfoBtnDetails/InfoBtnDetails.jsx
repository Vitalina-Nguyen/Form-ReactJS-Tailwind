            ...
            <div className={style.detailLabelText}>Please give us more details about your request*
                <span className={` ${style.goalInfoBtn}`}>
                    <button className="group">
                        ...
                        <div className={`group-focus:block ${style.goalInfoMassage_wrapper}`}>
                            <div className={style.goalInfoMassage}>
                                We want to understand your goals so we can provide you with the best solution for your needs.
