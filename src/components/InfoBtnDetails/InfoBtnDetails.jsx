    ...
    return (
        ...
        <label htmlFor="details">
            <div className={`${style.detailLabelText}`}>Please give us more details about your request*
                <span className={`group ${style.detailInfoBtn}`}>
                    <svg className="group-hover:fill-orange inline" width="13" height="13" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`group-hover:block ${style.detailInfoMassage_wrapper}`}>
                        <div className={style.detailInfoMassage}>
